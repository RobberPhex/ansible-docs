.. _avi_applicationpersistenceprofile:
...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>app_cookie_persistence_profile<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specifies the application cookie persistence profile parameters.</div>        </td></tr>
    ...
    <td></td>
        ...
        <td><div>User defined description for the object.</div>        </td></tr>
                <tr><td>hdr_persistence_profile<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specifies the custom http header persistence profile parameters.</div>        </td></tr>
                <tr><td>http_cookie_persistence_profile<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specifies the http cookie persistence profile parameters.</div>        </td></tr>
                <tr><td>ip_persistence_profile<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specifies the client ip persistence profile parameters.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>A user-friendly name for the persistence profile.</div>        </td></tr>
    ...
    <td></td>
        ...
        <td><div>Password of Avi user in Avi controller. The default value is the environment variable <code>AVI_PASSWORD</code>.</div>        </td></tr>
                <tr><td>persistence_type<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Method used to persist clients to the same server for a duration of time or a session.</div><div>Default value when not specified in API or module is interpreted by Avi Controller as PERSISTENCE_TYPE_CLIENT_IP_ADDRESS.</div>        </td></tr>
                <tr><td>server_hm_down_recovery<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specifies behavior when a persistent server has been marked down by a health monitor.</div><div>Default value when not specified in API or module is interpreted by Avi Controller as HM_DOWN_PICK_NEW_SERVER.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Uuid of the persistence profile.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> obj </td>
        <td> ApplicationPersistenceProfile (api/applicationpersistenceprofile) object </td>
