.. _avi_certificatemanagementprofile:
...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>Password of Avi user in Avi controller. The default value is the environment variable <code>AVI_PASSWORD</code>.</div>        </td></tr>
                <tr><td>script_params<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>List of customparams.</div>        </td></tr>
                <tr><td>script_path<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Script_path of certificatemanagementprofile.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> obj </td>
        <td> CertificateManagementProfile (api/certificatemanagementprofile) object </td>
