...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>The name of the network profile.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Networkprofileunion settings for networkprofile.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Uuid of the network profile.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> obj </td>
        <td> NetworkProfile (api/networkprofile) object </td>
