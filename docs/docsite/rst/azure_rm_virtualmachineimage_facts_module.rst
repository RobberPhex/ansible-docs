.. _azure_rm_virtualmachineimage_facts:
...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Azure location value (ie. westus, eastus, eastus2, northcentralus, etc.). Supplying only a location value will yield a list of available publishers for the location.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Only show results for a specific security group.</div>        </td></tr>
                <tr><td>offer<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Name of an image offering. Combine with sku to see a list of available image versions.</div>        </td></tr>
    ...
    <td></td>
        ...
        <td><div>Security profile found in ~/.azure/credentials file.</div>        </td></tr>
                <tr><td>publisher<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Name of an image publisher. List image offerings associated with a particular publisher.</div>        </td></tr>
    ...
    <td></td>
        ...
        <td><div>Azure client secret. Use when authenticating with a Service Principal.</div>        </td></tr>
                <tr><td>sku<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Image offering SKU. Combine with offer to see a list of available versions.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Specific version number of an image.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> azure_vmimages </td>
        <td> List of image dicts. </td>
