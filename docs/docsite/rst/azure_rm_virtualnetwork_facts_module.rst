.. _azure_rm_virtualnetwork_facts:
...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Limit results by resource group. Required when filtering by name.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> azure_virtualnetworks </td>
        <td> List of virtual network dicts. </td>
