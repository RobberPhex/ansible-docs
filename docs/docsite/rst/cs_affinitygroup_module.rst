...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Account the affinity group is related to.</div>        </td></tr>
                <tr><td>affinty_type<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Type of the affinity group. If not specified, first found affinity type is used.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Domain the affinity group is related to.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Name of the affinity group.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name of the project the affinity group is related to.</div>        </td></tr>
                <tr><td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li></ul></td>
        <td><div>State of the affinity group.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> project </td>
        <td> Name of project the affinity group is related to. </td>
        ...
        <td align=center> Production </td>
            ...
            <tr>
        <td> domain </td>
        <td> Domain the affinity group is related to. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> example domain </td>
            ...
            <tr>
        <td> description </td>
        <td> Description of affinity group. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> application affinity group </td>
    </tr>
            <tr>
        <td> name </td>
        ...
        <td align=center> app </td>
            ...
            <tr>
        <td> account </td>
        <td> Account the affinity group is related to. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> example account </td>
            ...
            <tr>
        <td> affinity_type </td>
        <td> Type of affinity group. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> host anti-affinity </td>
    </tr>
            <tr>
        <td> id </td>
        <td> UUID of the affinity group. </td>
        <td align=center> success </td>
        <td align=center> string </td>
