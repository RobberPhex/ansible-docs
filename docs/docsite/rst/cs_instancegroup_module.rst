...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Account the instance group is related to.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Domain the instance group is related to.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Name of the instance group.</div>        </td></tr>
                <tr><td>project<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Project the instance group is related to.</div>        </td></tr>
                <tr><td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li></ul></td>
        <td><div>State of the instance group.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> project </td>
        <td> Project the instance group is related to. </td>
        ...
        <td align=center> example project </td>
            ...
            <tr>
        <td> account </td>
        <td> Account the instance group is related to. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        ...
        <td align=center> webservers </td>
            ...
            <tr>
        <td> created </td>
        <td> Date when the instance group was created. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> 2015-05-03T15:05:51+0200 </td>
            ...
            <tr>
        <td> domain </td>
        <td> Domain the instance group is related to. </td>
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> example domain </td>
            ...
            <tr>
        <td> id </td>
        <td> UUID of the instance group. </td>
        <td align=center> success </td>
        <td align=center> string </td>
