...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Description of the role.</div>        </td></tr>
                <tr><td>id<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>ID of the role.</div><div>If provided, <code>id</code> is used as key.</div></br>
    <div style="font-size: small;">aliases: uuid<div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Name of the role.</div>        </td></tr>
                <tr><td>role_type<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>User</td>
        <td><ul><li>User</li><li>DomainAdmin</li><li>ResourceAdmin</li><li>Admin</li></ul></td>
        <td><div>Type of the role.</div><div>Only considered for creation.</div>        </td></tr>
                <tr><td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li></ul></td>
        <td><div>State of the role.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> success </td>
        <td align=center> string </td>
        <td align=center> This is my role description </td>
    </tr>
            <tr>
        <td> role_type </td>
        <td> Type of the role. </td>
        <td align=center> success </td>
        <td align=center> string </td>
