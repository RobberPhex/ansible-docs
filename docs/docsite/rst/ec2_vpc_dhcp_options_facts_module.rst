...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>DhcpOptionsIds<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>None</td>
        <td></td>
        <td><div>Get details of specific DHCP Option ID</div><div>Provide this value as a list</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> changed </td>
        <td> True if listing the dhcp options succeeds </td>
        ...
        <td align=center>  </td>
            ...
            <tr>
        <td> dhcp_options </td>
        <td> The dhcp option sets for the account </td>
        <td align=center> always </td>
