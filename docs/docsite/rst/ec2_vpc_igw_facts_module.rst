...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>A dict of filters to apply. Each dict item consists of a filter key and a filter value. See <a href='http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRouteTables.html'>http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRouteTables.html</a> for possible filters.</div>        </td></tr>
                <tr><td>internet_gateway_ids<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>None</td>
        <td></td>
        <td><div>Get details of specific Internet Gateway ID. Provide this value as a list.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td> The internet gateways for the account. </td>
        <td align=center> always </td>
        <td align=center> list </td>
        <td align=center> [{'internet_gateway_id': 'igw-2123634d', 'attachments': [{'vpc_id': 'vpc-02123b67', 'state': 'available'}], 'tags': [{'key': 'Name', 'value': 'test-vpc-20-igw'}]}] </td>
    </tr>
            <tr>
        <td> changed </td>
        <td> True if listing the internet gateways succeeds. </td>
        <td align=center> always </td>
