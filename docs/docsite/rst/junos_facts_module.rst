...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>config_format<br/><div style="font-size: small;"> (added in 2.3)</div></td>
    <td>no</td>
    <td>text</td>
        <td><ul><li>xml</li><li>set</li><li>text</li><li>json</li></ul></td>
        <td><div>The <em>config_format</em> argument specifies the format of the configuration when serializing output from the device. This argument is applicable only when <code>config</code> value is present in <em>gather_subset</em>.</div>        </td></tr>
                <tr><td>gather_subset<br/><div style="font-size: small;"> (added in 2.3)</div></td>
    <td>no</td>
    <td>!config</td>
        <td></td>
