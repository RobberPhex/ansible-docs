...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>acct_port<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
    ...
    <td></td>
        ...
        <td><div>Address or name of the radius or tacacs host.</div>        </td></tr>
                <tr><td>auth_port<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
    ...
    <td></td>
        ...
        <td><div>Specifies the DNS host name or address for connecting to the remote device over the specified transport.  The value of host is used as the destination address for the transport.</div>        </td></tr>
                <tr><td>host_timeout<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
    ...
    <td>present</td>
        ...
        <td><div>Manage the state of the resource.</div>        </td></tr>
                <tr><td>tacacs_port<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
