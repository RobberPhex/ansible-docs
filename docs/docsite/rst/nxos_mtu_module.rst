...
Deprecated in 2.3 use :ref:`nxos_system <nxos_system>`'s ``mtu`` option.
...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Full name of interface, i.e. Ethernet1/1.</div>        </td></tr>
                <tr><td>mtu<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>MTU for a specific interface. Must be an even number between 576 and 9216.</div>        </td></tr>
    ...
    <td>present</td>
        ...
        <td><div>Specify desired state of the resource.</div>        </td></tr>
                <tr><td>sysmtu<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>System jumbo MTU. Must be an even number between 576 and 9216.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> end_state </td>
        <td> k/v pairs of mtu/sysmtu values after module execution </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'sysmtu"': '9216', 'mtu': '1700'} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['interface vlan10', 'mtu 1700'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'mtu': '1700'} </td>
    </tr>
            <tr>
        <td> existing </td>
        <td> ['k/v pairs of existing mtu/sysmtu on the interface/system'] </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'sysmtu': '9216', 'mtu': '1600'} </td>
    </tr>
