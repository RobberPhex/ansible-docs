...
.. note::
    - This module works at the group level for traps.  If you need to only enable/disable 1 specific trap within a group, use the :ref:`nxos_command <nxos_command>` module.
