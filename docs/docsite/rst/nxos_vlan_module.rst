...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>Specifies the DNS host name or address for connecting to the remote device over the specified transport.  The value of host is used as the destination address for the transport.</div>        </td></tr>
                <tr><td>mapped_vni<br/><div style="font-size: small;"> (added in 2.2)</div></td>
    <td>no</td>
    <td></td>
        <td></td>
    ...
    <td></td>
        ...
        <td><div>Single VLAN ID.</div>        </td></tr>
                <tr><td>vlan_range<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Range of VLANs such as 2-10 or 2,5,10-15, etc.</div>        </td></tr>
                <tr><td>vlan_state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>active</td>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> commands </td>
        <td> Set of command strings to send to the remote device </td>
