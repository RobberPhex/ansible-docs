...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>admin_state<br/><div style="font-size: small;"> (added in 2.2)</div></td>
    <td>no</td>
    <td>no shutdown</td>
        <td><ul><li>shutdown</li><li>no shutdown</li></ul></td>
        <td><div>Used to enable or disable the VRRP process.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>VRRP virtual IP address.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> {'priority': '100', 'vip': '10.1.15.1', 'group': '150', 'admin_state': 'no shutdown', 'interval': '1', 'preempt': True, 'authentication': 'testing'} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['interface vlan10', 'vrrp 150', 'address 10.1.15.1', 'authentication text testing', 'no shutdown'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'group': '150', 'authentication': 'testing', 'admin_state': 'no shutdown', 'vip': '10.1.15.1'} </td>
    </tr>
            <tr>
        <td> existing </td>
