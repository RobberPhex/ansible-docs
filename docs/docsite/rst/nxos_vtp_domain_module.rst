...
.. note::
    ...
    - If it's never been configured before, VTP version is set to 1 by default. Otherwise, it leaves the previous configured version untouched. Use :ref:`nxos_vtp_version <nxos_vtp_version>` to change it.
    - Use this in combination with :ref:`nxos_vtp_password <nxos_vtp_password>` and :ref:`nxos_vtp_version <nxos_vtp_version>` to fully manage VTP operations.
