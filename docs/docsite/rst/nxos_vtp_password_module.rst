...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>If <code>no</code>, SSL certificates will not be validated. This should only be used on personally controlled sites using self-signed certificates.  If the transport argument is not nxapi, this value is ignored.</div>        </td></tr>
                <tr><td>vtp_password<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
...
.. note::
    ...
    - Use this in combination with :ref:`nxos_vtp_domain <nxos_vtp_domain>` and :ref:`nxos_vtp_version <nxos_vtp_version>` to fully manage VTP operations.
