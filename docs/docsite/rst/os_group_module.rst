...
.. raw:: html
    ...
    <td>None</td>
        ...
        <td><div>Group description</div>        </td></tr>
                <tr><td>domain_id<br/><div style="font-size: small;"> (added in 2.3)</div></td>
    <td>no</td>
    <td>None</td>
        <td></td>
        <td><div>Domain id to create the group in if the cloud supports domains.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> group </td>
        <td> Dictionary describing the group. </td>
    ...
    <td colspan=4>
        ...
        <th class="head">sample</th>
                ...
                <tr>
        <td> id </td>
        <td> Unique group ID </td>
        <td align=center>  </td>
        <td align=center> string </td>
        <td align=center> ee6156ff04c645f481a6738311aea0b0 </td>
        </tr>
                <tr>
        <td> domain_id </td>
        <td> Domain for the group </td>
        <td align=center>  </td>
        <td align=center> string </td>
