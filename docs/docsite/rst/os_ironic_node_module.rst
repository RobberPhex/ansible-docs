...
.. raw:: html
    ...
    <td>public</td>
        ...
        <td><div>Endpoint URL type to fetch from the service catalog.</div>        </td></tr>
                <tr><td rowspan="2">instance_info<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td><td></td>
    <td> <div>Definition of the instance information which is used to deploy the node.  This information is only required when an instance is set to present.</div>    </tr>
    <tr>
    <td colspan="5">
    <table border=1 cellpadding=4>
    <caption><b>Dictionary object instance_info</b></caption>
    <tr>
    <th class="head">parameter</th>
    <th class="head">required</th>
    <th class="head">default</th>
    ...
    <th class="head">comments</th>
                    ...
                    <tr><td>image_disk_format<br/><div style="font-size: small;"></div></td>
        <td>no</td>
        <td></td>
                <td></td>
                <td><div>The type of image that has been requested to be deployed.</div>        </td></tr>
                    <tr><td>image_source<br/><div style="font-size: small;"></div></td>
        <td>no</td>
        <td></td>
                <td></td>
                <td><div>An HTTP(S) URL where the image can be retrieved from.</div>        </td></tr>
                    <tr><td>image_checksum<br/><div style="font-size: small;"></div></td>
        <td>no</td>
        <td></td>
                <td></td>
                <td><div>The checksum of image_source.</div>        </td></tr>
        </table>
    </td>
    </tr>
        </td></tr>
    ...
    <td>None</td>
        ...
        <td><div>A path to a client key to use as part of the SSL transaction.</div>        </td></tr>
                <tr><td>maintenance<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>A setting to allow the direct control if a node is in maintenance mode.</div>        </td></tr>
                <tr><td>maintenance_reason<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>None</td>
        <td></td>
