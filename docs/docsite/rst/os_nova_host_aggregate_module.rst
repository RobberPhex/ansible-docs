...
.. raw:: html
    ...
    <td>None</td>
        <td></td>
        <td><div>Availability zone to create aggregate into.</div>        </td></tr>
    ...
    <td>None</td>
        <td></td>
        <td><div>List of hosts to set for an aggregate.</div>        </td></tr>
    ...
    <td>None</td>
        <td></td>
        <td><div>Metadata dict.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Name of the aggregate.</div>        </td></tr>
