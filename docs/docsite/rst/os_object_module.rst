...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>The name of the container in which to create the object</div>        </td></tr>
                <tr><td>container_access<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>private</td>
        <td><ul><li>private</li><li>public</li></ul></td>
        <td><div>desired container access level.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Path to local file to be uploaded.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name to be give to the object. If omitted, operations will be on the entire container</div>        </td></tr>
