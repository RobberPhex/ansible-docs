...
.. raw:: html
    ...
    <td>None</td>
        ...
        <td><div>Description for the project</div>        </td></tr>
                <tr><td>domain_id<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>None</td>
        <td></td>
        <td><div>Domain id to create the project in if the cloud supports domains. The domain_id parameter requires shade &gt;= 1.8.0</div></br>
