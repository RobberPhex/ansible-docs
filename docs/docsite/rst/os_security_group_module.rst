...
.. raw:: html
    ...
    <td>None</td>
        <td></td>
        <td><div>Long description of the purpose of the security group</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name that has to be given to the security group. This module requires that security group names be unique.</div>        </td></tr>
