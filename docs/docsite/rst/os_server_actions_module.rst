...
.. raw:: html
    ...
    <td>no</td>
    <td>present</td>
        <td><ul><li>stop</li><li>start</li><li>pause</li><li>unpause</li><li>lock</li><li>unlock</li><li>suspend</li><li>resume</li><li>rebuild</li></ul></td>
    ...
    <td>public</td>
        ...
        <td><div>Endpoint URL type to fetch from the service catalog.</div>        </td></tr>
                <tr><td>image<br/><div style="font-size: small;"> (added in 2.3)</div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Image the server should be rebuilt with</div>        </td></tr>
