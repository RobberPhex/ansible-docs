...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>ID of the domain to scope the role association to. Valid only with keystone version 3, and required if <em>project</em> is not specified.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name or ID for the group. Valid only with keystone version 3. If <em>group</em> is not specified, then <em>user</em> is required. Both may not be specified.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name or ID of the project to scope the role association to. If you are using keystone version 2, then this value is required.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name or ID for the role.</div>        </td></tr>
                <tr><td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li></ul></td>
        <td><div>Should the roles be present or absent on the user.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name or ID for the user. If <em>user</em> is not specified, then <em>group</em> is required. Both may not be specified.</div>        </td></tr>
