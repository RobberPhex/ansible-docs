...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search cluster X from datacenter Y use following pattern: name=X and datacenter=Y</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_clusters </td>
        <td> List of dictionaries describing the clusters. Cluster attribues are mapped to dictionary keys, all clusters attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/cluster. </td>
