...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search datacenter <em>X</em> use following pattern: <em>name=X</em></div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_datacenters </td>
        <td> List of dictionaries describing the datacenters. Datacenter attribues are mapped to dictionary keys, all datacenters attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/data_center. </td>
