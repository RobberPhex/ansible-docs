...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search group X use following pattern: name=X</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_groups </td>
        <td> List of dictionaries describing the groups. Group attribues are mapped to dictionary keys, all groups attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/group. </td>
