...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Authorization provider of the group. In previous versions of oVirt known as domain.</div></br>
    ...
    <td></td>
        <td></td>
        <td><div>Namespace of the authorization provider, where group resides.</div>        </td></tr>
    ...
    <td>present</td>
        ...
        <td><div>Should the group be present/absent.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> group </td>
        <td> Dictionary of all the group attributes. Group attributes can be found on your oVirt instance at following url: https://ovirt.example.com/ovirt-engine/api/model#types/group. </td>
        <td align=center> On success if group is found. </td>
        <td align=center>  </td>
        <td align=center>  </td>
    </tr>
            <tr>
        <td> id </td>
        <td> ID of the group which is managed </td>
        <td align=center> On success if group is found. </td>
