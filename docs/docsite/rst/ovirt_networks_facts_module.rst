...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search network starting with string vlan1 use: name=vlan1*</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_networks </td>
        <td> List of dictionaries describing the networks. Network attribues are mapped to dictionary keys, all networks attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/network. </td>
