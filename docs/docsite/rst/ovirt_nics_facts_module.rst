...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Name of the NIC, can be used as glob expression.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name of the VM where NIC is attached.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_nics </td>
        <td> List of dictionaries describing the network interfaces. NIC attribues are mapped to dictionary keys, all NICs attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/nic. </td>
