...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Name of the the group to manage.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Username of the the user to manage. In most LDAPs it's <em>uid</em> of the user, but in Active Directory you must specify <em>UPN</em> of the user.</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_permissions </td>
        <td> List of dictionaries describing the permissions. Permission attribues are mapped to dictionary keys, all permissions attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/permission. </td>
