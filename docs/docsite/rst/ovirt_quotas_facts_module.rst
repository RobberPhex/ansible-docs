...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Name of the datacenter where quota resides.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name of the quota, can be used as glob expression.</div>        </td></tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_quotas </td>
        <td> List of dictionaries describing the quotas. Quota attribues are mapped to dictionary keys, all quotas attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/quota. </td>
