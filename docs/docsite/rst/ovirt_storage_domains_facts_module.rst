...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search storage domain X from datacenter Y use following pattern: name=X and datacenter=Y</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_storage_domains </td>
        <td> List of dictionaries describing the storage domains. Storage_domain attribues are mapped to dictionary keys, all storage domains attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/storage_domain. </td>
