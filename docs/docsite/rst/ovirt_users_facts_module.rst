...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Search term which is accepted by oVirt search backend.</div><div>For example to search user X use following pattern: name=X</div>        </td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> ovirt_users </td>
        <td> List of dictionaries describing the users. User attribues are mapped to dictionary keys, all users attributes can be found at following url: https://ovirt.example.com/ovirt-engine/api/model#types/user. </td>
