...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>Provide login username if user is not root.</div>        </td></tr>
                <tr><td>pn_cluster_node1<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Specify the name of the first switch in the cluster.</div><div>Required for 'cluster-create'.</div>        </td></tr>
                <tr><td>pn_cluster_node2<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
    ...
    <td></td>
        ...
        <td><div>Specify the name of the cluster.</div>        </td></tr>
                <tr><td>pn_validate<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
