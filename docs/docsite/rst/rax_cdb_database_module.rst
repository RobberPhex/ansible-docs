...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>The databases server UUID</div>        </td></tr>
                <tr><td>character_set<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>utf8</td>
        <td></td>
        <td><div>Set of symbols and encodings</div>        </td></tr>
                <tr><td>collate<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>utf8_general_ci</td>
        <td></td>
        <td><div>Set of rules for comparing characters in a character set</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Name to give to the database</div>        </td></tr>
