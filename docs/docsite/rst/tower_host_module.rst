...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>The description to use for the host.</div>        </td></tr>
                <tr><td>enabled<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>True</td>
        <td></td>
        <td><div>If the host should be enabled.</div>        </td></tr>
                <tr><td>inventory<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Inventory the host should be made a member of.</div>        </td></tr>
                <tr><td>name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>The name to use for the host.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>Variables to use for the host. Use '@' for a file.</div>        </td></tr>
        </table>
    </br>
