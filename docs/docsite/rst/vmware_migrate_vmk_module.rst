...
.. raw:: html
    ...
    <th class="head">comments</th>
                ...
                <tr><td>current_portgroup_name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Portgroup name VMK interface is currently on</div>        </td></tr>
                <tr><td>current_switch_name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
    ...
    <td></td>
        ...
        <td><div>The hostname or IP address of the vSphere vCenter.</div>        </td></tr>
                <tr><td>migrate_portgroup_name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Portgroup name to migrate VMK interface to</div>        </td></tr>
                <tr><td>migrate_switch_name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
