...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Etherstub name.</div></td></tr>
            <tr>
    <td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li></ul></td>
        <td><div>Create or delete Solaris/illumos etherstub.</div></td></tr>
            <tr>
    <td>temporary<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>Specifies that the etherstub is temporary. Temporary etherstubs do not persist across reboots.</div></td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> True </td>
            ...
            <tr>
        <td> name </td>
        <td> etherstub name </td>
        <td align=center> always </td>
        <td align=center> string </td>
        <td align=center> switch0 </td>
    </tr>
