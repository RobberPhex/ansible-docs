...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>The elastic IP address to associate with the instance.</div><div>If absent, allocate a new address</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Reuse an EIP that is not associated to an instance (when available), instead of allocating a new one.</div></td></tr>
            <tr>
    ...
    <td>present</td>
        ...
        <td><div>If present, associate the IP with the instance.</div><div>If absent, disassociate the IP with the instance.</div></td></tr>
            <tr>
