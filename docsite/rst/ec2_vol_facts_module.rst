...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>A dict of filters to apply. Each dict item consists of a filter key and a filter value. See <a href='http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVolumes.html'>http://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVolumes.html</a> for possible filters.</div></td></tr>
            <tr>
