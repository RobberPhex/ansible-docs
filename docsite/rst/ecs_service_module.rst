...
.. raw:: html
    ...
    <td>10</td>
        ...
        <td><div>The time to wait before checking that the service is available</div></td></tr>
            <tr>
    <td>desired_count<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>The count of how many instances of the service</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>The task definition the service will run</div></td></tr>
            <tr>
...
.. note:: the service role specified must be assumable (i.e. have a trust relationship for the ecs service, ecs.amazonaws.com)
.. note:: for details of the parameters and returns see http://boto3.readthedocs.org/en/latest/reference/services/ecs.html
