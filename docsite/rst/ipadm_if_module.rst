...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>IP interface name.</div></td></tr>
            <tr>
    <td>state<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>present</td>
        <td><ul><li>present</li><li>absent</li><li>enabled</li><li>disabled</li></ul></td>
        <td><div>Create or delete Solaris/illumos IP interfaces.</div></td></tr>
            <tr>
    <td>temporary<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>Specifies that the IP interface is temporary. Temporary IP interfaces do not persist across reboots.</div></td></tr>
        </table>
    </br>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> present </td>
            ...
            <tr>
        <td> temporary </td>
        <td> persistence of a IP interface </td>
        <td align=center> always </td>
