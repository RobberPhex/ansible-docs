...
.. raw:: html
    ...
    <td>yes</td>
        ...
        <td>If <code>no</code>, SSL certificates will not be validated. This should only be set to <code>no</code> when no other option exists.  Prior to 1.9.3 the code defaulted to <code>no</code>. (added in Ansible 1.9.3)</td>
    </tr>
        </table>
