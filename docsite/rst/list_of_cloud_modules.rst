...
.. toctree:: :maxdepth: 1
  ...
  _ec2_ami_search (E) - Retrieve AWS AMI information for a given operating system. <_ec2_ami_search_module>
...
.. toctree:: :maxdepth: 1
  ...
  docker_login (E) - Manage Docker registry logins <docker_login_module>
...
.. toctree:: :maxdepth: 1
  ...
  _glance_image (E) - Add/Delete images from glance <_glance_image_module>
  _keystone_user (E) - Manage OpenStack Identity (keystone) users, tenants and roles <_keystone_user_module>
  _nova_compute (E) - Create/Delete VMs from OpenStack <_nova_compute_module>
  _nova_keypair (E) - Add/Delete key pair from nova <_nova_keypair_module>
  _quantum_floating_ip (E) - Add/Remove floating IP from an instance <_quantum_floating_ip_module>
  _quantum_floating_ip_associate (E) - Associate or disassociate a particular floating IP with an instance <_quantum_floating_ip_associate_module>
  _quantum_network (E) - Creates/Removes networks from OpenStack <_quantum_network_module>
  _quantum_router (E) - Create or Remove router from openstack <_quantum_router_module>
  _quantum_router_gateway (E) - set/unset a gateway interface for the router with the specified external network <_quantum_router_gateway_module>
  _quantum_router_interface (E) - Attach/Dettach a subnet's interface to a router <_quantum_router_interface_module>
  _quantum_subnet (E) - Add/remove subnet from a network <_quantum_subnet_module>
