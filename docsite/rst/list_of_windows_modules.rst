...
.. toctree:: :maxdepth: 1
  ...
  win_package (E) - Installs/Uninstalls an installable package, either from local file system or url <win_package_module>
  ...
  win_robocopy (E) - Synchronizes the contents of two directories using Robocopy. <win_robocopy_module>
