...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>Direction ACL to be applied in on the interface.</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Full name of interface, e.g. <em>Ethernet1/1</em>.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> ['interface ethernet1/41', 'ip access-group ANSIBLE out'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> {'interface': 'ethernet1/41', 'direction': 'egress', 'name': 'ANSIBLE'} </td>
    </tr>
            <tr>
        <td> end_state </td>
        <td> k/v pairs of interface ACL after module execution </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'interface': 'ethernet1/41', 'direction': 'egress', 'name': 'ANSIBLE'} </td>
    </tr>
        ...
        <td align=center> True </td>
            ...
            <tr>
        <td> acl_applied_to </td>
        <td> list of interfaces the ACL is applied to </td>
        <td align=center> always </td>
        <td align=center> list </td>
        <td align=center> [{'interface': 'Ethernet1/41', 'direction': 'egress', 'acl_type': 'Router ACL', 'name': 'ANSIBLE'}] </td>
    </tr>
            <tr>
        <td> existing </td>
        <td> k/v pairs of existing ACL applied to the interface </td>
        <td align=center>  </td>
        <td align=center> dict </td>
        <td align=center> {} </td>
    </tr>
