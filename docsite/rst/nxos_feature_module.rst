...
.. raw:: html
    ...
    <th class="head">comments</th>
            ...
            <tr>
    <td>feature<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>Name of feature.</div></td></tr>
            <tr>
    ...
    <td>enabled</td>
        ...
        <td><div>Desired state of the feature.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> ['no feature eigrp'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        <td> proposed feature state </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'state': 'disabled'} </td>
    </tr>
            <tr>
        <td> end_state </td>
        <td> feature state after executing module </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'state': 'disabled'} </td>
    </tr>
        ...
        <td align=center> True </td>
            ...
            <tr>
        <td> feature </td>
        <td> the feature that has been examined </td>
        <td align=center> always </td>
        <td align=center> string </td>
        <td align=center> vpc </td>
            ...
            <tr>
        <td> existing </td>
        <td> existing state of feature </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'state': 'enabled'} </td>
    </tr>
