...
.. raw:: html
    ...
    <th class="head">comments</th>
            ...
            <tr>
    <td>enforce_rtr_alert<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>Enables or disables the enforce router alert option check for IGMPv2 and IGMPv3 packets.</div></td></tr>
            <tr>
    <td>flush_routes<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>Removes routes when the IGMP process is restarted. By default, routes are not flushed.</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>Restarts the igmp process (using an exec config command).</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> end_state </td>
        <td> k/v pairs of IGMP configuration after module execution </td>
        <td align=center> verbose mode </td>
        <td align=center> dict </td>
        <td align=center> {'enforce_rtr_alert': True, 'flush_routes': True} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['ip igmp flush-routes'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> {'enforce_rtr_alert': True, 'flush_routes': True} </td>
            ...
            <tr>
        <td> existing </td>
        <td> k/v pairs of existing IGMP configuration </td>
        <td align=center> verbose mode </td>
        <td align=center> dict </td>
        <td align=center> {'enforce_rtr_alert': True, 'flush_routes': False} </td>
    </tr>
...
.. note:: When ``state=default``, all supported params will be reset to a default state.
