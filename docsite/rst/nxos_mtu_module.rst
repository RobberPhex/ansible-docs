...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>MTU for a specific interface.</div></td></tr>
            <tr>
    ...
    <td>present</td>
        ...
        <td><div>Specify desired state of the resource.</div></td></tr>
            <tr>
    <td>sysmtu<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>System jumbo MTU.</div></td></tr>
            <tr>
...
.. note:: Either ``sysmtu`` param is required or ``interface`` AND ``mtu`` params are req'd.
.. note:: ``state=absent`` unconfigures a given MTU if that value is currently present.
