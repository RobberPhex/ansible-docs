...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Safeguard boolean. Set to true if you're sure you want to reboot.</div></td></tr>
            <tr>
...
.. note:: The module will fail due to timeout issues, but the reboot will be performed anyway.
