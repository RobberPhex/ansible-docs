...
.. raw:: html
    ...
    <th class="head">comments</th>
            ...
            <tr>
    <td>checkpoint_file<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>Name of checkpoint file to create. Mutually exclusive with rollback_to.</div></td></tr>
            <tr>
    ...
    <td></td>
        ...
        <td><div>Convenience method that allows all <em>nxos</em> arguments to be passed as a dict object.  All constraints (required, choices, etc) must be met either by individual arguments or values in this dict.</div></td></tr>
            <tr>
    <td>rollback_to<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>Name of checkpoint file to rollback to. Mutually exclusive with checkpoint_file.</div></td></tr>
            <tr>
...
.. note:: Sometimes ``transport=nxapi`` may cause a timeout error.
