...
.. raw:: html
    ...
    <th class="head">comments</th>
            ...
            <tr>
    <td>access<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul><li>ro</li><li>rw</li></ul></td>
        <td><div>Access type for community.</div></td></tr>
            <tr>
    <td>acl<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>1</td>
        <td><ul></ul></td>
        <td><div>ACL name to filter snmp requests.</div></td></tr>
            <tr>
    <td>community<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>Case-sensitive community string.</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Group to which the community belongs.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> end_state </td>
        <td> k/v pairs of snmp community after module execution </td>
        <td align=center> always </td>
        <td align=center> dict or null </td>
        <td align=center> {'group': 'network-operator', 'acl': 'None'} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['snmp-server community TESTING7 group network-operator'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> {'group': 'network-operator'} </td>
    </tr>
            <tr>
        <td> existing </td>
        <td> k/v pairs of existing snmp community </td>
        <td align=center>  </td>
        <td align=center> dict </td>
        <td align=center> {} </td>
    </tr>
