...
.. raw:: html
    ...
    <td></td>
        <td><ul><li>true</li><li>false</li></ul></td>
        <td><div>The module, by default, will collect the current device running-config to use as a base for comparision to the commands in <em>src</em>.  Setting this value to true will cause the module to issue the command `show running-config all` to include all device settings.</div></td></tr>
            <tr>
