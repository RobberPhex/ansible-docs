...
.. raw:: html
    ...
    <td>yes</td>
    <td></td>
        <td><ul><li>enabled</li><li>disabled</li><li>aggressive</li></ul></td>
        <td><div>Manages UDLD mode for an interface.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> {'mode': 'enabled'} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['interface ethernet1/33', 'no udld aggressive ; no udld disable'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center>  </td>
        <td align=center> dict </td>
        <td align=center> {'mode': 'aggressive'} </td>
    </tr>
...
.. note:: Feature UDLD must be enabled on the device to use this module.
