...
.. raw:: html
    ...
    <td>up</td>
        ...
        <td><div>Manage the VLAN administrative state of the VLAN equivalent to shut/no shut in VLAN config mode.</div></td></tr>
            <tr>
    ...
    <td></td>
        ...
        <td><div>Specifies the DNS host name or address for connecting to the remote device over the specified transport.  The value of host is used as the destination address for the transport.</div></td></tr>
            <tr>
    <td>mapped_vni<br/><div style="font-size: small;"> (added in 2.2)</div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>The Virtual Network Identifier (VNI) ID that is mapped to the VLAN. Valid values are integer and keyword 'default'.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <td align=center> {'vlan_state': 'suspend', 'admin_state': 'down', 'name': 'app_vlan', 'mapped_vni': '5000'} </td>
    </tr>
            <tr>
        ...
        <td align=center> {'vlan_state': 'suspend', 'admin_state': 'down', 'name': 'app_vlan', 'vlan_id': '20', 'mapped_vni': ''} </td>
    </tr>
            <tr>
        <td> updates </td>
        ...
        <td align=center> always </td>
        <td align=center> list </td>
        <td align=center> ['vlan 20', 'vlan 55', 'vn-segment 5000'] </td>
    </tr>
            <tr>
        <td> end_state </td>
        ...
        <td align=center> always </td>
        <td align=center> dict or null </td>
        <td align=center> {'vlan_state': 'suspend', 'admin_state': 'down', 'name': 'app_vlan', 'vlan_id': '20', 'mapped_vni': '5000'} </td>
    </tr>
            <tr>
