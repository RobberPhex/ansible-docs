...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Full name of interface to be managed, i.e. Ethernet1/1.</div></td></tr>
            <tr>
...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> end_state </td>
        <td> k/v pairs of vrf after module execution </td>
        <td align=center> always </td>
        <td align=center> dict </td>
        <td align=center> {'interface': 'loopback16', 'vrf': 'ntc'} </td>
    </tr>
            <tr>
        <td> changed </td>
        ...
        <td align=center> ['interface loopback16', 'vrf member ntc'] </td>
    </tr>
            <tr>
        <td> proposed </td>
        ...
        <td align=center> {'interface': 'loopback16', 'vrf': 'ntc'} </td>
            ...
            <tr>
        <td> existing </td>
        <td> k/v pairs of existing vrf on the interface </td>
        <td align=center>  </td>
        <td align=center> dict </td>
        <td align=center> {'interface': 'loopback16', 'vrf': ''} </td>
    </tr>
...
.. note:: VRF needs to be added globally with :ref:`nxos_vrf <nxos_vrf>` before adding a VRF to an interface.
.. note:: Remove a VRF from an interface will still remove all L3 attributes just as it does from CLI.
.. note:: VRF is not read from an interface until IP address is configured on that interface.
