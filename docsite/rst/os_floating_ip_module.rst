...
.. raw:: html
    ...
    <td>public</td>
        ...
        <td><div>Endpoint URL type to fetch from the service catalog.</div></td></tr>
            <tr>
    <td>fixed_address<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>To which fixed IP of server the floating IP address should be attached to.</div></td></tr>
            <tr>
    <td>floating_ip_address<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>A floating IP address to attach or to detach. Required only if state is absent. When state is present can be used to specify a IP address to attach.</div></td></tr>
            <tr>
    ...
    <td></td>
        ...
        <td><div>Name of the region.</div></td></tr>
            <tr>
    <td>reuse<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>When state is present, and floating_ip_address is not present, this parameter can be used to specify whether we should try to reuse a floating IP address already allocated to the project.</div></td></tr>
            <tr>
