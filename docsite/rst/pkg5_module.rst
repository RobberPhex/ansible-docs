...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td>An FRMI of the package(s) to be installed/removed/updated.Multiple packages may be specified, separated by <code>,</code>.</td>
    </tr>
            <tr>
    <td>state</td>
    <td>no</td>
    <td>present</td>
        ...
        <td>Whether to install (<em>present</em>, <em>latest</em>), or remove (<em>absent</em>) a package.</td>
    </tr>
        </table>
