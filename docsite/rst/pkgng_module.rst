...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>pkg will chroot in the specified environment</div><div>can not be used together with 'rootdir' option</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>for pkgng versions 1.5 and later, pkg will install all packages within the specified root directory</div><div>can not be used together with 'chroot' option</div></td></tr>
            <tr>
