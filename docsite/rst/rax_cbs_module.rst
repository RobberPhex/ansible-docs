...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td>image to use for bootable volumes. Can be an <code>id</code>, <code>human_id</code> or <code>name</code>. This option requires <code>pyrax&gt;=1.9.3</code> (added in Ansible 1.9)</td>
    </tr>
            <tr>
    <td>meta</td>
    <td>no</td>
