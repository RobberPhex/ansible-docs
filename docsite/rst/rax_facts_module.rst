...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Server IP address to retrieve facts for, will match any IP assigned to the server</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Server ID to retrieve facts for</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>Server name to retrieve facts for</div></td></tr>
            <tr>
