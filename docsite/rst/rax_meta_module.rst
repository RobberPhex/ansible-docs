...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td>Server IP address to modify metadata for, will match any IP assigned to the server</td>
    </tr>
            <tr>
    <td>api_key</td>
    <td>no</td>
    ...
    <td></td>
        <td><ul></ul></td>
        <td>Server ID to modify metadata for</td>
    </tr>
            <tr>
    <td>identity_type</td>
    <td>no</td>
    ...
    <td></td>
        <td><ul></ul></td>
        <td>Server name to modify metadata for</td>
    </tr>
            <tr>
    <td>region</td>
    <td>no</td>
