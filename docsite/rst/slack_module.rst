...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td>Slack (sub)domain for your environment without protocol. (i.e. <code>future500.slack.com</code>) In 1.8 and beyond, this is deprecated and may be ignored.  See token documentation for information.</td>
    </tr>
            <tr>
    <td>icon_emoji</td>
    <td>no</td>
