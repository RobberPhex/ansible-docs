...
.. raw:: html
    ...
    <th class="head">sample</th>
        ...
        <tr>
        <td> attributes_set </td>
        <td> The attributes which were changed </td>
        <td align=center> state == "present" </td>
        <td align=center> list </td>
        <td align=center> ['policy', 'delivery_policy'] </td>
    </tr>
            <tr>
        <td> subscriptions_deleted </td>
        <td> The subscriptions deleted from the topic </td>
        <td align=center> state == "present" </td>
        <td align=center> list </td>
        <td align=center> [['sms', 'my_mobile_number'], ['sms', 'my_mobile_2']] </td>
    </tr>
            <tr>
        <td> topic_created </td>
        <td> Whether the topic was newly created </td>
        <td align=center> changed and state == present </td>
        <td align=center> bool </td>
        <td align=center> True </td>
    </tr>
            <tr>
        <td> subscriptions_added </td>
        <td> The subscriptions added to the topic </td>
        <td align=center> state == "present" </td>
        <td align=center> list </td>
        <td align=center> [['sms', 'my_mobile_number'], ['sms', 'my_mobile_2']] </td>
    </tr>
