...
.. raw:: html
    ...
    <td>no</td>
        <td><ul><li>yes</li><li>no</li></ul></td>
        <td>If <code>yes</code>, modified files will be discarded. If <code>no</code>, module will fail if it encounters modified files. Prior to 1.9 the default was `yes`.</td>
    </tr>
            <tr>
    <td>password</td>
    <td>no</td>
