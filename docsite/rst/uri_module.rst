...
.. raw:: html
    ...
    <td>GET</td>
        ...
        <td>The HTTP method of the request or response. It MUST be uppercase.</td>
    </tr>
            <tr>
    <td>others</td>
    <td>no</td>
    ...
    <td>yes</td>
        <td><ul><li>yes</li><li>no</li></ul></td>
        <td>If <code>no</code>, SSL certificates will not be validated.  This should only set to <code>no</code> used on personally controlled sites using self-signed certificates.  Prior to 1.9.2 the code defaulted to <code>no</code>. (added in Ansible 1.9.2)</td>
    </tr>
        </table>
